...
public class TestSessionCrypto  {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (
             ...
             FileInputStream plainin = new FileInputStream("/Users/iceroot/WorkingDev/InternetSecurity-IK2206/VPN/test/java/testInput.txt");
             ) {
        ...
        try (
            ...
            FileOutputStream plainout = new FileOutputStream("/Users/iceroot/WorkingDev/InternetSecurity-IK2206/VPN/test/java/testOutput.txt");
             ) {
